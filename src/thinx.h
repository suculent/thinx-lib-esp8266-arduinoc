...
const char * THINX_APP_VERSION = "thinx-lib-esp8266-arduino:2.1.157:2017-12-06";
const char * THINX_CLOUD_URL = "thinx.cloud";
const char * THINX_COMMIT_ID = "c2d13320cca4df4149bc94e7c19692299eca3fcf";
const char * THINX_FIRMWARE_VERSION = "thinx-lib-esp8266-arduino:2.1.157";
const char * THINX_FIRMWARE_VERSION_SHORT = "2.1.157";
